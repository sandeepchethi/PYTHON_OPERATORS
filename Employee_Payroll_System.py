...
#creating frames
Tops = Frame(window, width=1350, height=50, bd=8, bg="light blue")
Tops.pack()

f1 = Frame(window, width=600, height=600, bd=8, bg="light green")
f1.pack(side=LEFT)
...
btnpayslip=Button(flb, text='View Payslip', padx=10, pady=10, bd=8, font=('arial', 7, 'bold'), width=6,command=enterinfo, fg="red", bg="powder blue").grid(row=0, column=2)
